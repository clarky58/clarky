          ...
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-2">
              <div>
                ...
                asset('upload/admin_images/'.$profileData->photo) : asset('upload/no_image.jpg') }}" alt="profile">

                <span class="h4 ms-3 text">{{ $profileData->username }}</span>
              </div>
            </div>
            <div class="mt-3">
...
<label for="exampleInputUsername1" class="form-label">Username</label>
 ...
 value={{ $profileData->username }}>
  ...
  <div class="mb-3"> <label for="exampleInputEmail1" class="form-label">Phone</label>
 ...
 value={{ $profileData->address }}>
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label"></label>
                                            <img id="showImage" class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ?
